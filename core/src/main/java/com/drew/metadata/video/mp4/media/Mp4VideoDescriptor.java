...
public class Mp4VideoDescriptor extends TagDescriptor<Mp4VideoDirectory>
{
    ...
    {
        Integer value = _directory.getInteger(Mp4VideoDirectory.TAG_DEPTH);
        if (value == null)
            return null;
    ...
    {
        Integer value = _directory.getInteger(Mp4VideoDirectory.TAG_COLOR_TABLE);
        if (value == null)
            return null;

        switch (value) {
            case (-1):
                Integer depth = _directory.getInteger(Mp4VideoDirectory.TAG_DEPTH);
                if (depth == null)
                    return "None";
    ...
    {
        Integer value = _directory.getInteger(Mp4VideoDirectory.TAG_GRAPHICS_MODE);
        if (value == null)
            return null;
