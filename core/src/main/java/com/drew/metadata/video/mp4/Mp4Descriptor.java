...
public class Mp4Descriptor extends TagDescriptor<Mp4Directory> {
    ...
    private String getCompatibleBrandsDescription()
    {
        ...
        for (String value : values) {
            String compatibleBrandsValue = Mp4Dictionary.lookup(Mp4Directory.TAG_MAJOR_BRAND, value);
    ...
    {
        Rational duration = _directory.getRational(Mp4Directory.TAG_DURATION_SECONDS);
        if (duration == null)
            return null;
