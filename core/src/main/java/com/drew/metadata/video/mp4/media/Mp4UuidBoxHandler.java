 ...
 */
package com.drew.metadata.video.mp4.media;

import com.drew.filetypes.video.mp4.Mp4Handler;
...
import com.drew.metadata.video.mp4.Mp4BoxTypes;
import com.drew.metadata.video.mp4.Mp4Context;

import java.io.IOException;
import java.nio.ByteBuffer;
import java.util.UUID;

import static com.drew.metadata.video.mp4.media.Mp4UuidBoxDirectory.TAG_USER_DATA;
import static com.drew.metadata.video.mp4.media.Mp4UuidBoxDirectory.TAG_UUID;
