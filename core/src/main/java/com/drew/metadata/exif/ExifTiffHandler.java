...
import com.drew.filetypes.imaging.jpeg.JpegMetadataReader;
import com.drew.filetypes.imaging.jpeg.JpegProcessingException;
import com.drew.filetypes.imaging.tiff.TiffHandler;
import com.drew.filetypes.imaging.tiff.TiffProcessingException;
import com.drew.filetypes.imaging.tiff.TiffReader;
...
import com.drew.metadata.exif.epson.PrintIMDirectory;
import com.drew.metadata.exif.makernotes.apple.AppleMakernoteDirectory;
import com.drew.metadata.exif.makernotes.canon.CanonMakernoteDirectory;
import com.drew.metadata.exif.makernotes.casio.CasioType1MakernoteDirectory;
import com.drew.metadata.exif.makernotes.casio.CasioType2MakernoteDirectory;
import com.drew.metadata.exif.makernotes.fuji.FujifilmMakernoteDirectory;
import com.drew.metadata.exif.makernotes.kodak.KodakMakernoteDirectory;
import com.drew.metadata.exif.makernotes.kyocera.KyoceraMakernoteDirectory;
import com.drew.metadata.exif.makernotes.leica.LeicaMakernoteDirectory;
import com.drew.metadata.exif.makernotes.leica.LeicaType5MakernoteDirectory;
import com.drew.metadata.exif.makernotes.nikon.NikonType1MakernoteDirectory;
import com.drew.metadata.exif.makernotes.nikon.NikonType2MakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusCameraSettingsMakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusEquipmentMakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusFocusInfoMakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusImageProcessingMakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusMakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusRawDevelopment2MakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusRawDevelopmentMakernoteDirectory;
import com.drew.metadata.exif.makernotes.olympus.OlympusRawInfoMakernoteDirectory;
import com.drew.metadata.exif.makernotes.panasonic.PanasonicMakernoteDirectory;
import com.drew.metadata.exif.makernotes.pentax.PentaxMakernoteDirectory;
import com.drew.metadata.exif.makernotes.reconyx.ReconyxHyperFire2MakernoteDirectory;
import com.drew.metadata.exif.makernotes.reconyx.ReconyxHyperFireMakernoteDirectory;
import com.drew.metadata.exif.makernotes.reconyx.ReconyxUltraFireMakernoteDirectory;
import com.drew.metadata.exif.makernotes.ricoh.RicohMakernoteDirectory;
import com.drew.metadata.exif.makernotes.samsung.SamsungType2MakernoteDirectory;
import com.drew.metadata.exif.makernotes.sanyo.SanyoMakernoteDirectory;
import com.drew.metadata.exif.makernotes.sigma.SigmaMakernoteDirectory;
import com.drew.metadata.exif.makernotes.sony.SonyTag9050bDirectory;
import com.drew.metadata.exif.makernotes.sony.SonyType1MakernoteDirectory;
import com.drew.metadata.exif.makernotes.sony.SonyType6MakernoteDirectory;
import com.drew.metadata.exif.panasonic.PanasonicRawDistortionDirectory;
import com.drew.metadata.exif.panasonic.PanasonicRawIFD0Directory;
import com.drew.metadata.exif.panasonic.PanasonicRawWbInfo2Directory;
import com.drew.metadata.exif.panasonic.PanasonicRawWbInfoDirectory;
import com.drew.metadata.imaging.icc.IccReader;
import com.drew.metadata.imaging.photoshop.PhotoshopReader;
import com.drew.metadata.imaging.tiff.DirectoryTiffHandler;
import com.drew.metadata.imaging.xmp.XmpReader;
import com.drew.metadata.iptc.IptcReader;
import com.drew.metadata.video.apple.AppleRunTimeReader;
...
/**
 * Implementation of {@link TiffHandler} used for handling TIFF tags according to the Exif
 * standard.
 * <p>
