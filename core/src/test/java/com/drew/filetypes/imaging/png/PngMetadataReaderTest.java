 ...
 */
package com.drew.filetypes.imaging.png;

import com.drew.lang.KeyValuePair;
import com.drew.lang.annotations.NotNull;
import com.drew.metadata.Metadata;
import com.drew.metadata.imaging.png.PngDirectory;
...
public class PngMetadataReaderTest
{
    ...
    public void testGimpGreyscaleWithManyChunks() throws Exception
    {
        ...
        try {
            ...
            Metadata metadata = processFile("gimp-8x12-greyscale-alpha-time-background.png");
            ...
            Assert.assertEquals(PngChunkType.IHDR, dirs[0].getPngChunkType());
            ...
            Assert.assertEquals(PngChunkType.gAMA, dirs[1].getPngChunkType());
            assertEquals(0.45455, dirs[1].getDouble(PngDirectory.TAG_GAMMA), 0.00001);

            Assert.assertEquals(PngChunkType.bKGD, dirs[2].getPngChunkType());
            assertArrayEquals(new byte[]{0, 52}, dirs[2].getByteArray(PngDirectory.TAG_BACKGROUND_COLOR));

            //noinspection ConstantConditions
            Assert.assertEquals(PngChunkType.pHYs, dirs[3].getPngChunkType());
            ...
            Assert.assertEquals(PngChunkType.tIME, dirs[4].getPngChunkType());
            ...
            Assert.assertEquals(PngChunkType.iTXt, dirs[5].getPngChunkType());
