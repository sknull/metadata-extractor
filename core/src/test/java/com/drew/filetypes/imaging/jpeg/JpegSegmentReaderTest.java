...
public class JpegSegmentReaderTest
{
    ...
    {
        JpegSegmentData segmentData = JpegSegmentReader.readSegments(TestHelper.getResourceFile("withExifAndIptc.jpg"), null);

        assertEquals(1, segmentData.getSegmentCount(JpegSegmentType.APP0));
        assertArrayEquals(
                TestHelper.readBytes("withExifAndIptc.jpg.app0"),
        ...
        assertArrayEquals(
                TestHelper.readBytes("withExifAndIptc.jpg.app1.0"),
                segmentData.getSegment(JpegSegmentType.APP1, 0));
        assertArrayEquals(
                TestHelper.readBytes("withExifAndIptc.jpg.app1.1"),
        ...
        assertArrayEquals(
                TestHelper.readBytes("withExifAndIptc.jpg.app2"),
        ...
        assertArrayEquals(
                TestHelper.readBytes("withExifAndIptc.jpg.appd"),
        ...
        assertArrayEquals(
                TestHelper.readBytes("withExifAndIptc.jpg.appe"),
    ...
    public void testReadSpecificSegments() throws Exception
    {
        JpegSegmentData segmentData = JpegSegmentReader.readSegments(
                TestHelper.getResourceFile("withExifAndIptc.jpg"),
    ...
    {
        JpegSegmentData segmentData = JpegSegmentReader.readSegments(TestHelper.getResourceFile("noExif.jpg"), null);
    ...
    {
        try {
            JpegSegmentReader.readSegments(TestHelper.getResourceFile("this-is-no-image.txt"), null);
