...
public class PngChunkTypeTest
{
    ...
    public void testConstructorTooLong() throws Exception
    {
        try {
            ...
            Assert.assertEquals("PNG chunk type identifier must be four bytes in length", ex.getMessage());
        }
    }
    ...
    public void testConstructorInvalidBytes() throws Exception
    {
        ...
        for (String invalidString : invalidStrings) {
            try {
                ...
                Assert.assertEquals("PNG chunk type identifier may only contain alphabet characters", ex.getMessage());
            }
        }
    }
