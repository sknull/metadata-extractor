...
public class PngChunkReaderTest
{
    ...
    {
        return Iterables.toList(new PngChunkReader().extract(TestHelper.getStreamReader(filePath), null));
    }

    @Test
    public void testExtractMspaint() throws Exception
    {
        List<PngChunk> chunks = processFile("mspaint-8x10.png");
    ...
    {
        List<PngChunk> chunks = processFile("photoshop-8x12-rgba32.png");
