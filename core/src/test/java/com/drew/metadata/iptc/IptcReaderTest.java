...
public class IptcReaderTest
{
    ...
    {
        IptcDirectory directory = processBytes("iptc1.jpg.appd");
    ...
    {
        IptcDirectory directory = processBytes("iptc2-photoshop6.jpg.appd");
    ...
    {
        IptcDirectory directory = processBytes("iptc-encoding-defined-utf8.bytes");
    ...
    {
        IptcDirectory directory = processBytes("iptc-encoding-undefined-iso.bytes");
    ...
    {
        IptcDirectory directory = processBytes("iptc-encoding-unknown.bytes");
    ...
    public void testIptcEncodingUnknown2() throws Exception
    {
        ...
        IptcDirectory directory = processBytes("iptc-encoding-unknown-2.bytes");
