...
package com.drew.metadata.imaging.gif;
...
{
    @NotNull
    public static GifHeaderDirectory processBytes(@NotNull String resource) throws Exception
    {
    ...
    {
        GifHeaderDirectory directory = processBytes("mspaint-10x10.gif");
    ...
    {
        GifHeaderDirectory directory = processBytes("photoshop-8x12-32colors-alpha.gif");
