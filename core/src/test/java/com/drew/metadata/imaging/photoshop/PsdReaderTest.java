...
{
    @NotNull
    public static PsdHeaderDirectory processBytes(@NotNull String resource) throws Exception
    {
    ...
    {
        PsdHeaderDirectory directory = processBytes("8x4x8bit-Grayscale.psd");
    ...
    {
        PsdHeaderDirectory directory = processBytes("10x12x16bit-CMYK.psd");
