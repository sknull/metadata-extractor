 ...
 */
package com.drew.metadata.imaging.jpeg;
...
import com.drew.metadata.imaging.jpeg.HuffmanTablesDirectory.HuffmanTable.HuffmanTableClass;
...
public class JpegDhtReaderTest
{
    ...
    public static HuffmanTablesDirectory processBytes(String filePath) throws Exception
    {
        ...
        JpegSegmentData segmentData = JpegSegmentReader.readSegments(
            TestHelper.getResourceFile(filePath),
    ...
    {
        _directory = processBytes("withExifAndIptc.jpg");
    }
