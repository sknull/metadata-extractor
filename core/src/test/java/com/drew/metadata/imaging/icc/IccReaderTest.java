...
package com.drew.metadata.imaging.icc;
...
public class IccReaderTest
{
    ...
    {
        byte[] app2Bytes = TestHelper.readBytes("iccDataInvalid1.jpg.app2");
    ...
    {
        byte[] app2Bytes = TestHelper.readBytes("withExifAndIptc.jpg.app2");
