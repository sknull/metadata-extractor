...
package com.drew.metadata.imaging.adobe;
...
public class AdobeJpegReaderTest
{
    ...
    public static AdobeJpegDirectory processBytes(@NotNull String filePath) throws IOException
    {
        ...
        new AdobeJpegReader().extract(new SequentialByteArrayReader(TestHelper.readBytes(filePath)), metadata);
    ...
    {
        AdobeJpegDirectory directory = processBytes("adobeJpeg1.jpg.appe");
