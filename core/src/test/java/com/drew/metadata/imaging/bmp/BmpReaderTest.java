...
{
    @NotNull
    public static BmpHeaderDirectory processBytes(@NotNull String resource) throws Exception
    {
        Metadata metadata = new Metadata();
        new BmpReader().extract(TestHelper.getStreamReader(resource), metadata);
    ...
    {
        BmpHeaderDirectory directory = processBytes("16color-10x10.bmp");
    ...
    {
        BmpHeaderDirectory directory = processBytes("24bpp-10x10.bmp");
