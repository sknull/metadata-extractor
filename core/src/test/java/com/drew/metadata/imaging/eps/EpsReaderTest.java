...
{
    @NotNull
    public static EpsDirectory processBytes(@NotNull String resource) throws Exception
    {
    ...
    {
        EpsDirectory directory = processBytes("8x4x8bit-Grayscale.eps");
    ...
    {
        EpsDirectory directory = processBytes("adobeJpeg1.eps");
