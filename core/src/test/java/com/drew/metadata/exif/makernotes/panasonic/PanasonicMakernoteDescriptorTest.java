...
package com.drew.metadata.exif.makernotes.panasonic;
...
public class PanasonicMakernoteDescriptorTest
{
    ...
    {
        _panasonicDirectory = ExifReaderTest.processBytes("withPanasonicFaces.jpg.app1", PanasonicMakernoteDirectory.class);
    }
