...
import com.drew.filetypes.imaging.jpeg.JpegSegmentType;
...
public class ExifReaderTest
{
    ...
    public static Metadata processBytes(@NotNull String filePath) throws IOException
    {
        ...
        byte[] bytes = TestHelper.readBytes(filePath);
    ...
    {
        ExifSubIFDDirectory directory = ExifReaderTest.processBytes("withExif.jpg.app1", ExifSubIFDDirectory.class);
...
//      assertEquals("F9", directory.getDescription(ExifSubIFDDirectory.TAG_APERTURE));
    ...
    public void testCrashRegressionTest() throws Exception
    {
        ...
        ExifSubIFDDirectory directory = ExifReaderTest.processBytes("crash01.jpg.app1", ExifSubIFDDirectory.class);
    ...
    {
        ExifIFD0Directory directory = ExifReaderTest.processBytes("manuallyAddedThumbnail.jpg.app1", ExifIFD0Directory.class);
    ...
    {
        ExifThumbnailDirectory directory = ExifReaderTest.processBytes("manuallyAddedThumbnail.jpg.app1", ExifThumbnailDirectory.class);
    ...
    public void testStackOverflowOnRevisitationOfSameDirectory() throws Exception
    {
        ...
        Metadata metadata = processBytes("recursiveDirectories.jpg.app1");
    ...
    public void testDifferenceImageAndThumbnailOrientations() throws Exception
    {
        ...
        Metadata metadata = processBytes("repeatedOrientationTagWithDifferentValues.jpg.app1");
