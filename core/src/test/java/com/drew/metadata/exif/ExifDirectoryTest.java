...
public class ExifDirectoryTest
{
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("nikonMakernoteType2a.jpg.app1");
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("withUncompressedRGBThumbnail.jpg.app1");
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("withExifAndIptc.jpg.app1.0");
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("withPanasonicFaces.jpg.app1");
